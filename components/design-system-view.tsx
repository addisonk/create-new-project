      ...
      <section className="container mx-auto max-w-7xl px-6 py-16 md:px-10">
        ...
        <div>
          <div className="relative rounded-2xl ring ring-foreground/10 dark:ring-foreground/10">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-muted dark:bg-muted/30">
              <div className="h-[80vh] overflow-y-auto overflow-x-hidden p-10 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                <BlockErrorBoundary>
                  <React.Suspense
                    fallback={
                      <div className="flex h-96 items-center justify-center text-muted-foreground">
